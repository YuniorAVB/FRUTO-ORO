...
public class TicketIngresoCopiaGui extends javax.swing.JFrame implements Printable {

    ModeloTicketEntiti ticket;

    public TicketIngresoCopiaGui() {
        initComponents();
    ...
    public void getDatosTicket() {
        int ticketId = BuscarTicketGui.pesaje.getTic_id();
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(TicketIngresoCopiaGui.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }


        /* Create and display the form */
        java.awt.EventQueue.invokeLater(() -> {
            new TicketIngresoCopiaGui().setVisible(true);
        });
    }
