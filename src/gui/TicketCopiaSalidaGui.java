...
public class TicketCopiaSalidaGui extends javax.swing.JFrame implements Printable {

    ModeloTicketEntiti ticket;
    public static int ticket_id = -1;

    public TicketCopiaSalidaGui() {
        initComponents();
    ...
    public void getDatosTicket() {
        int ticketSerie = BuscarTicketGui.pesaje.getTic_serie_numero();
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(TicketCopiaSalidaGui.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }


        /* Create and display the form */
        java.awt.EventQueue.invokeLater(() -> {
            new TicketCopiaSalidaGui().setVisible(true);
        });
    }
