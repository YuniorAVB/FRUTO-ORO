...
public class EmpresaGui extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jtxt_ruc.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jtxt_ruc, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    public void checkUpdateOrCreate() {
        ...
        if (id_empresa > -1) {
            empresa = EmpresaController.getEmpresaById(id_empresa);
            jtxt_nombre.setText(empresa.getEpr_nombre());
            jtxt_ruc.setText(empresa.getEpr_ruc());
        }
    ...
    private void jlbl_guardarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jlbl_guardarMouseClicked
        ...
        String ruc = jtxt_ruc.getText();

        if (id_empresa > -1) {
            EmpresaController.updateEmpresa(nombre, nombre, id_empresa);

        } else {
            EmpresaController.insertEmpresa(nombre, ruc);
        }
        MantenimientoGui.id_objeto = -1;
        this.dispose();
    ...
    private javax.swing.JTextField jtxt_ruc;
