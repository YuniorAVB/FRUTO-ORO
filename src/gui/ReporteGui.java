...
public class ReporteGui extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jlbl_tipo_reporte.setText("CONDUCTOR");

        jdt_fecha_desde.setDateFormatString("yyyy/MM/d");
        jdt_fecha_desde.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N

        jdt_fecha_hasta.setDateFormatString("yyyy/MM/d");
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel10Layout.createSequentialGroup()
                .addGroup(jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel10Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addGroup(jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jtxt_buscar, javax.swing.GroupLayout.DEFAULT_SIZE, 417, Short.MAX_VALUE)
        ...
        jPanel10Layout.setVerticalGroup(
            ...
            .addGroup(jPanel10Layout.createSequentialGroup()
                ...
                .addGroup(jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(jtxt_buscar, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jlbl_generar_reporteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jlbl_generar_reporteMouseClicked
        ...
        if (jdt_fecha_desde.getDate() != null && jdt_fecha_hasta.getDate() != null) {

            String fechaDesde = sdf.format(jdt_fecha_desde.getDate());
            String fechaHasta = sdf.format(jdt_fecha_hasta.getDate());
            try {

                String tipo = jcb_tipo_reporte.getSelectedItem().toString();
                String buscar = jtxt_buscar.getText();

                ExportExcel.generateExcel(tipo, buscar, fechaDesde, fechaHasta);
            } catch (Exception ex) {
