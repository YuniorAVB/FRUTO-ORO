...
public class PesajeTicketController {
    ...
    public static PesajeTicketEntiti getBuscarTicketByTicket(int ticket_serie) {
        PesajeTicketEntiti pesaje = PesajeTicketModel.getPesajeTicketIngresoByTicket(new PesajeTicketEntiti(0, ticket_serie));
        PesajeTicketEntiti pesaje_buscar = null;
        
        if (pesaje != null) {
            
            boolean existe = PesajeModel.checkTicketSalidaById(pesaje.getTic_pes_id());
            
            if (existe) {
                
                pesaje_buscar = PesajeTicketModel.getPesajeTicketByTicket(pesaje);
            }
        }
        
        return pesaje_buscar;
    ...
    public static PesajeTicketEntiti getLastPesajeTicketIngreso() {
        
        PesajeTicketEntiti pesaje_last = PesajeTicketModel.getPesajeTicketLastSerie();
        
        PesajeTicketEntiti pesaje_ingreso = PesajeTicketModel.getPesajeTicketIngresoById(pesaje_last);
        
        return pesaje_ingreso;
